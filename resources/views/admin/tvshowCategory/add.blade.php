...
<div class="container mt-5">
    <div class="row">
        <div class="col-6 offset-3">
            <a href="{{route('tvshowCategory#list')}}" class=""><button class="btn btn-sm text-light" style="background-color: #003060"><i class="fa-solid fa-arrow-left"></i></button></a>
            <div class="card  text-light mt-3">
                <div class="card-header text-light" style="background-color:#003060"><h3 style="text-align:center; ">Add Tvshow Category</h3></div>
                <div class="card-body">
                    <div id="error" class="alert alert-danger " style="display:none"><i class="fa-solid fa-circle-exclamation"></i>&nbsp;&nbsp;</div>
                    <form action="{{route('tvshowCategory#create')}}" method="POST" id="form" onsubmit = "return(validate())";>
                        @csrf
