            ...
            <div class="card" style="background-color: rgba(0, 48, 96,0.8)">
                <div class="card-header" style="display: flex; justify-content:space-between">
                    ...
                    <div class="heading d-lg-block d-md-block d-sm-none d-none">
                        <h3 class="text-white text-decoration-underline">User-List</h3>
                    </div>
                    <form action="{{route('user#search2')}}" method="get">
                        @csrf
                            ...
                            <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('adminUser#edit',$item['id'])}}"><button class="btn btn-sm bg-dark text-white"><i class="fas fa-edit"></i></button></a>
                                                <a href="{{route('adminUser#delete',$item['id'])}}"><button class="btn btn-sm bg-danger text-white"><i class="fas fa-trash-alt"></i></button></a></td>
                                        </tr>
                                        @endforeach
                                        <tr class="pb-0">
