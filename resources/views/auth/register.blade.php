...
background-size:cover;">
    <form style="margin-top: 10px;" data-aos="fade-up" method="POST" action="{{ route('register') }}">
@csrf
        <fieldset class="reg_fieldset" style="background-image: url('{{asset('images/movie.png')}}');">
            <legend class="legend">Register <span>your account</span></legend>
            <img src="{{asset('images/Movieverse (3).png')}}" alt="" style="margin-top:20px;">
            <div class="box" style="margin-top: 20px;">
                <input type="text" name="name" placeholder="Enter username" class="name_box" required>
            </div>
            <div class="box">
                <input type="email" placeholder="Enter your email" name="email" class="reg_email" required>
            </div>
            <div class="box">
                <input type="password" placeholder="Enter your password" name="password" class="reg_pwd" required>
            </div>
            <div class="box">
                <input type="password" placeholder="re-type password" name="password_confirmation" class="confirm_pwd" required>
            </div>
            <div class="btn">
                <button type="submit" class="btn1">Sign up</button>
                <a href="{{route('welcome')}}">
                    <button type="button" class="btn2">Back</button>
                </a>
            </div>
        </fieldset>
    </form>
