        ...
        <div class="heading">
            <nav class="navbar text-black">
                ...
                <ul class="nav-menu mt-1">
                    ...
                    <li class="nav-item">
                        <a href="{{route('user#profile',Auth::user()->id)}}" class=" text-white "><button class="btn mt-2 text-light">{{Auth::user()->name}}</button></a>
                    </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6" id="desc">
                            ...
                            <p>{{$data->review}}</p>
                            <button type="button" id="but" class="btn" onclick="reveal()" style="background-color: #003060;">Watch Trailer</button>
                            <button type="button " id="but2 " class="btn btn-outline-primary d-inline-block d-lg-none ">Download</button>
                        </div>
                        <?php
                            $i = 0;
                            ?>
                        <div class="col-3 d-none d-lg-block mt-3">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-heading{{$i}}">
                                        <button class="accordion-button collapsed p-3 btn btn-dark" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{$i}}" aria-expanded="false" aria-controls="flush-collapse{{$i}}">
                                      Episodes-{{$i}}
                                    </button>
                                    </h2>
                                    <div id="flush-collapse{{$i}}" class="accordion-collapse collapse" aria-labelledby="flush-heading{{$i}}" data-bs-parent="#accordionFlushExample">
                                        <a href='{{route('user#episodeDetails',$item->episodes_id)}}'>
                                            <div class="accordion-body bg-white" style="color: #003060">{{$item->episodes_name}}</div>
                                        </a>
                                    </div>
                                </div>
                                @endforeach
