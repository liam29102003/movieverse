                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6" id="desc">
                            ...
                            <button type="button" id="download" class="btn btn-outline-primary d-inline-block d-lg-none ">Download</button>
                        </div>
                        <div class="col-2 download d-none d-lg-block " style="position: relative; ">
                            <form action="{{route('download#insert',$data->movies_id)}}" method='post'>
                                @csrf
                            <Button class="btn btn-warning btn-lg text-white" onclick="popup()" style="background-color: #003060; ">Download</Button>
                        </form>
                        </div>
                    </div>
                </div>
