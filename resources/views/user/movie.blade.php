...
<div id = 'body' style="background-image: url('{{asset('images/moon-knight-illustration-poster-w5.jpg')}}');
background-size: cover;">
    <!-- <nav id="navbar">
        <h1>MOVIESVERSE</h1>
    ...
    <div class="container  " id="search">
        <div class="row height d-flex justify-content-center align-items-center">
            <div class="col-md-8">
                <form action="{{route('user#search')}}" method="get" autocomplete="off" >
                <div class="search">
                    <i class="fa fa-search"></i>
                    <input type="text" onfocus = "darken()" onblur = 'lighten()' onkeyup="auto(event)" class="form-control autoCompleteInput" placeholder="Search Movies, Series, Animes" name='user_search'>
                ...
                <div class="movierow ">
                    ...
                    <a class="column" style="position: relative;" href="{{route('user#moviesDetails',$item->movies_id)}}">
                        <div class="moviecard" style="width: 200px; height:350px; overflow:hidden" onmouseover="myOpacity('{{$item->movies_id}}')" onmouseleave="myNoOpacity('{{$item->movies_id}}')">
                            <img src="{{asset('uploads/'.$item->poster)}}" alt=" " width="210px" height="300px " class="image">
...
<link href="https://fonts.googleapis.com/css2?family=Aboreto&display=swap" rel="stylesheet">
    ...
    return;
        ...
        //  console.log(filteredProduct[0].movies_id.toString());
        ...
        if(hasProductToShow){
...

            {
                ...
                productItemContainer.id = filteredProduct[i].movies_id;
...
const selectProduct = (index) => {
  const productIdToSelect = filteredProduct[index].movies_id.toString();
